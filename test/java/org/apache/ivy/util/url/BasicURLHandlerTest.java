...
//            new File(testDir, "nh80-deflate.pdf"));
        ...
        URL url = new URL("https://maven.aliyun.com/repository/public/org/apache/yetus/audience-annotations/0.5.0/audience-annotations-0.5.0.pom");
        File file = new File(testDir, "audience.pom");
